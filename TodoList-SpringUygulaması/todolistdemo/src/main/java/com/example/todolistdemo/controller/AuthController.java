...
import com.example.todolistdemo.responses.AuthResponse;
import com.example.todolistdemo.security.JwtTokenProvider;
import com.example.todolistdemo.services.UserService;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public AuthResponse login(@RequestBody AddUserRequest loginRequest) {
